...
import { fetchSnacks } from "@/Data/FetchData";
...
export default function DisplayBreakfast() {
  ...
  return (
    <div className="flex flex-col gap-5 items-center justify-center border-t sm:h-screen">
      <h1 className="text-3xl font-bold mt-5 sm:mt-0">Snacks</h1>

      <div className="flex flex-col gap-5 items-center justify-center">
        {SnacksData.map((items: any) => (
          <div className="flex flex-col gap-2">
            ...
            <DataCard
              ...
              data={items}
              id={items.id}
              onDelete={() => Delete("addSnacks", items.id)}
              mealType="Snacks"
            />
          </div>
        ))}
